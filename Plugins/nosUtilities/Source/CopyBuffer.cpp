...
{
struct CopyBufferNode : NodeContext
{
...
nosResult RegisterCopyBuffer(nosNodeFunctions* fn)
{
	NOS_BIND_NODE_CLASS(NOS_NAME("CopyBuffer"), CopyBufferNode, fn);
	return NOS_RESULT_SUCCESS;
}
