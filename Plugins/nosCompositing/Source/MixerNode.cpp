...
static std::string NosFormatStr(nosFormat format)
{
	switch (format)
	{
	case NOS_FORMAT_NONE: return "NONE";
	case NOS_FORMAT_R8_UNORM: return "R8_UNORM";
	case NOS_FORMAT_R8_UINT: return "R8_UINT";
	case NOS_FORMAT_R8_SRGB: return "R8_SRGB";
	case NOS_FORMAT_R8G8_UNORM: return "R8G8_UNORM";
	case NOS_FORMAT_R8G8_UINT: return "R8G8_UINT";
	case NOS_FORMAT_R8G8_SRGB: return "R8G8_SRGB";
	case NOS_FORMAT_R8G8B8_UNORM: return "R8G8B8_UNORM";
	case NOS_FORMAT_R8G8B8_SRGB: return "R8G8B8_SRGB";
	case NOS_FORMAT_B8G8R8_UNORM: return "B8G8R8_UNORM";
	case NOS_FORMAT_B8G8R8_UINT: return "B8G8R8_UINT";
	case NOS_FORMAT_B8G8R8_SRGB: return "B8G8R8_SRGB";
	case NOS_FORMAT_R8G8B8A8_UNORM: return "R8G8B8A8_UNORM";
	case NOS_FORMAT_R8G8B8A8_UINT: return "R8G8B8A8_UINT";
	case NOS_FORMAT_R8G8B8A8_SRGB: return "R8G8B8A8_SRGB";
	case NOS_FORMAT_B8G8R8A8_UNORM: return "B8G8R8A8_UNORM";
	case NOS_FORMAT_B8G8R8A8_SRGB: return "B8G8R8A8_SRGB";
	case NOS_FORMAT_A2R10G10B10_UNORM_PACK32: return "A2R10G10B10_UNORM_PACK32";
	case NOS_FORMAT_A2R10G10B10_SNORM_PACK32: return "A2R10G10B10_SNORM_PACK32";
	case NOS_FORMAT_A2R10G10B10_USCALED_PACK32: return "A2R10G10B10_USCALED_PACK32";
	case NOS_FORMAT_A2R10G10B10_SSCALED_PACK32: return "A2R10G10B10_SSCALED_PACK32";
	case NOS_FORMAT_A2R10G10B10_UINT_PACK32: return "A2R10G10B10_UINT_PACK32";
	case NOS_FORMAT_A2R10G10B10_SINT_PACK32: return "A2R10G10B10_SINT_PACK32";
	case NOS_FORMAT_R16_UNORM: return "R16_UNORM";
	case NOS_FORMAT_R16_SNORM: return "R16_SNORM";
	case NOS_FORMAT_R16_USCALED: return "R16_USCALED";
	case NOS_FORMAT_R16_SSCALED: return "R16_SSCALED";
	case NOS_FORMAT_R16_UINT: return "R16_UINT";
	case NOS_FORMAT_R16_SINT: return "R16_SINT";
	case NOS_FORMAT_R16_SFLOAT: return "R16_SFLOAT";
	case NOS_FORMAT_R16G16_UNORM: return "R16G16_UNORM";
	case NOS_FORMAT_R16G16_SNORM: return "R16G16_SNORM";
	case NOS_FORMAT_R16G16_USCALED: return "R16G16_USCALED";
	case NOS_FORMAT_R16G16_SSCALED: return "R16G16_SSCALED";
	case NOS_FORMAT_R16G16_UINT: return "R16G16_UINT";
	case NOS_FORMAT_R16G16_SINT: return "R16G16_SINT";
	case NOS_FORMAT_R16G16_SFLOAT: return "R16G16_SFLOAT";
	case NOS_FORMAT_R16G16B16_UNORM: return "R16G16B16_UNORM";
	case NOS_FORMAT_R16G16B16_SNORM: return "R16G16B16_SNORM";
	case NOS_FORMAT_R16G16B16_USCALED: return "R16G16B16_USCALED";
	case NOS_FORMAT_R16G16B16_SSCALED: return "R16G16B16_SSCALED";
	case NOS_FORMAT_R16G16B16_UINT: return "R16G16B16_UINT";
	case NOS_FORMAT_R16G16B16_SINT: return "R16G16B16_SINT";
	case NOS_FORMAT_R16G16B16_SFLOAT: return "R16G16B16_SFLOAT";
	case NOS_FORMAT_R16G16B16A16_UNORM: return "R16G16B16A16_UNORM";
	case NOS_FORMAT_R16G16B16A16_SNORM: return "R16G16B16A16_SNORM";
	case NOS_FORMAT_R16G16B16A16_USCALED: return "R16G16B16A16_USCALED";
	case NOS_FORMAT_R16G16B16A16_SSCALED: return "R16G16B16A16_SSCALED";
	case NOS_FORMAT_R16G16B16A16_UINT: return "R16G16B16A16_UINT";
	case NOS_FORMAT_R16G16B16A16_SINT: return "R16G16B16A16_SINT";
	case NOS_FORMAT_R16G16B16A16_SFLOAT: return "R16G16B16A16_SFLOAT";
	case NOS_FORMAT_R32_UINT: return "R32_UINT";
	case NOS_FORMAT_R32_SINT: return "R32_SINT";
	case NOS_FORMAT_R32_SFLOAT: return "R32_SFLOAT";
	case NOS_FORMAT_R32G32_UINT: return "R32G32_UINT";
	case NOS_FORMAT_R32G32_SINT: return "R32G32_SINT";
	case NOS_FORMAT_R32G32_SFLOAT: return "R32G32_SFLOAT";
	case NOS_FORMAT_R32G32B32_UINT: return "R32G32B32_UINT";
	case NOS_FORMAT_R32G32B32_SINT: return "R32G32B32_SINT";
	case NOS_FORMAT_R32G32B32_SFLOAT: return "R32G32B32_SFLOAT";
	case NOS_FORMAT_R32G32B32A32_UINT: return "R32G32B32A32_UINT";
	case NOS_FORMAT_R32G32B32A32_SINT: return "R32G32B32A32_SINT";
	case NOS_FORMAT_R32G32B32A32_SFLOAT: return "R32G32B32A32_SFLOAT";
	case NOS_FORMAT_B10G11R11_UFLOAT_PACK32: return "B10G11R11_UFLOAT_PACK32";
	case NOS_FORMAT_D16_UNORM: return "D16_UNORM";
	case NOS_FORMAT_X8_D24_UNORM_PACK32: return "X8_D24_UNORM_PACK32";
	case NOS_FORMAT_D32_SFLOAT: return "D32_SFLOAT";
	case NOS_FORMAT_G8B8G8R8_422_UNORM: return "G8B8G8R8_422_UNORM";
	case NOS_FORMAT_B8G8R8G8_422_UNORM: return "B8G8R8G8_422_UNORM";
...
static std::string NosFieldTypeStr(nosTextureFieldType fieldType)
{
	switch (fieldType)
	{
	case NOS_TEXTURE_FIELD_TYPE_UNKNOWN: return "Unknown";
	case NOS_TEXTURE_FIELD_TYPE_EVEN:
	case NOS_TEXTURE_FIELD_TYPE_ODD: return "Interlace";
	case NOS_TEXTURE_FIELD_TYPE_PROGRESSIVE: return "Progressive";
	default: return "Invalid";
	}
}
...
struct MixerContext : public NodeContext
{
	...
	void AddTextureDebugText(TextBuilder& textBuilder,
	                         const char* label,
	...
	void UpdateDebugTextsIfNeeded(nos::NodeExecuteParams const& params)
	{
		...
		if (needsMultiviewerDebugTextUpdate)
		{
			...
			AddTextureDebugText(textBuilder,
			                    "Multiviewer",
			                    LastMultiviewerDebugInfo,
			                    glm::vec2(0.0f, 4 * 0.018f),
			                    0.018f);
	...
	void UpdateTransition(float elapsed)
	{
		...
		if (amount >= 1.0f)
		{
			if (TransitionTarget == MixerTransitionTarget::Program)
			{
	...
	nos::ObjectRef getTransitionTextureInfo(nos::NodeExecuteParams const& params)
	{
		...
		TransitionTextureInfo.Texture.Height = outputTextureInfo.Texture.Height;
		TransitionTextureInfo.Texture.Format = outputTextureInfo.Texture.Format;
		nosVulkan->CreateResource(&TransitionTextureInfo,
		                          0,
		                          "MixerNode_TransitionTexture",
		                          &TransitionTexture.GetStorage());
	...
	bool UpdateLabelsTextureIfNeeded(nos::NodeExecuteParams const& params)
	{
		...
		)
		{
			...
			nosVulkan->CreateResource(&outputTextureInfo,
			                          0,
			                          "MixerNode_MultiviewerLabelsTexture",
			                          &MultiviewerLabelsTexture.GetStorage());
			return true;
		}
		else
		{
	...
	void Calculate_Multiviewer(nos::NodeExecuteParams const& params, nosCmd& cmd)
	{
...

		{
			...
			std::vector bindings = {
				...
				nos::sys::vulkan::ShaderTextureBinding(NSN_MultiviewerLabels,
				                                       MultiviewerLabelsTexture,
	...
	void Calculate_Transition(nos::NodeExecuteParams const& params, nosCmd& cmd)
	{
		...
		auto& sourceTextureInfo = TransitionTarget == MixerTransitionTarget::Program
			                          ? programTexture
			                          : previewTexture;
		auto outputTextureInfo = getTransitionTextureInfo(params);
		if (TransitionType == MixerTransitionType::Dissolve)
		{
		...
		{
			auto wipeLeft = TransitionType == MixerTransitionType::WipeLeft;
			auto wipeRight = TransitionType == MixerTransitionType::WipeRight;
			auto wipeUp = TransitionType == MixerTransitionType::WipeUp;
			auto wipeDown = TransitionType == MixerTransitionType::WipeDown;
